...
bool spec_troll_member( CHAR_DATA *ch)
{
	...
	default:  message = NULL; 	break;
        case 0: message = "$n yells '{_I've been looking for you, punk!{x'";
		break;
	...
	case 3: message = "$n cracks his knuckles and says '{SDo ya feel lucky?{x'";
		break;
        case 4: message = "$n says '{_There's no cops to save you this time!{x'";
		break;	
        case 5: message = "$n says '{_Time to join your brother, spud.{x'";
		break;
        case 6: message = "$n says '{_Let's rock.{x'";
		break;
    }
...
bool spec_boaz( CHAR_DATA *ch)
{
    ...
    {
	default: message = NULL;	break;
        case 0: message = "$n yells '{_Leave me alone!{x'";
                break;
        case 1: message = "With a scream of rage, $n attacks $N.";
                break;
        case 2: message = "$n shouts '{_Stop that! Stop that!{x' and attacks.";
                break;
	case 3: message = NULL;	break;
        case 4: message = "$n snorts a line of cocaine.";
                break;
        case 5: message = "$n yells '{_Get out!{x'";
                break;
        case 6: message = "$n shouts '{_Leave mommy alone, you little shit!{x'";
                break;
...
bool spec_patrolman(CHAR_DATA *ch)
{
    ...
    {
	default:	message = NULL;		break;
        case 0: message = "$n yells '{_All roit! All roit! break it up!{x'";
		break;
	case 1: message = 
                "$n says '{_Society's to blame, but what's a bloke to do?{x'";
		break;
	case 2: message = 
                "$n mumbles '{_bloody kids will be the death of us all.{x'";
		break;
        case 3: message = "$n shouts '{_Stop that! Stop that!{T' and attacks.";
		break;
	...
	case 5: message = 
		...
		break;
        case 6: message = "$n says '{_Settle down, you hooligans!{x'";
		break;
    }
...
bool spec_cast_adept( CHAR_DATA *ch )
{
	...
	act("$n utters the words 'judicandus eqtuyp'.",ch,NULL,NULL,TO_ROOM);
        spell_steel_flesh(skill_lookup("steel flesh"),
            ch->level,ch,victim,TARGET_CHAR);
        return TRUE;
...
bool spec_guard( CHAR_DATA *ch )
{
    ...
    if ( ech != NULL )
    {
        act( "$n screams '{_PROTECT THE INNOCENT!!  BANZAI!!{x",
...
bool spec_mayor( CHAR_DATA *ch )
{
    ...
    case 'b':
        act( "{x$n says '{_What a view!  I must do something about that dump!{x'",
	    ch, NULL, NULL, TO_ROOM );
	break;

    case 'c':
        act( "{x$n says '{_Vandals!  Youngsters have no respect for anything!{x'",
	    ch, NULL, NULL, TO_ROOM );
	break;
    ...
    case 'e':
        act( "{x$n says '{_I hereby declare the city of Midgaard open!{x'",
	    ch, NULL, NULL, TO_ROOM );
	break;
...
bool spec_cloaked_enforcer( CHAR_DATA *ch )
{
	...
	&&   can_see(ch,victim))
            { crime = "an Enemy of Midgaard"; break; }
