 ...
 void do_snattack(CHAR_DATA *ch, char *argument)
{
        ...
        if(ch->clan != clan_lookup("nightshade") || ch->clan == clan_lookup("nightshade") )
        {
         send_to_char("Huh?\n\r",ch);
         return;
        }
...
/* void do_nightwish(CHAR_DATA *ch, char *argument)
{
  AFFECT_DATA af;
        ...
        if(ch->clan != clan_lookup("nightshade"))
        {
         send_to_char("Huh?\n\r",ch);
         return;
        }
 ...
 void do_divide(CHAR_DATA *ch, char *argument)
{
  AFFECT_DATA af;
        ...
        if(ch->clan != clan_lookup("conquest"))
        {
         send_to_char("Huh?\n\r",ch);
         return;
        }
...
void do_bloodlust(CHAR_DATA *ch, char *argument)
{
           ...
           if(ch->clan != clan_lookup("wolfpack"))
        {
         send_to_char("Huh?\n\r",ch);
         return;
        }
