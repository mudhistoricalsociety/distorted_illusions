...
//{ 
//   OLD
//    if (buf_size[0] >= val)      /* 16 */
//        return buf_size[0]; 
//    else if (buf_size[1] >= val) /* 32 */
//        return buf_size[1]; 
//    else if (buf_size[2] >= val) /* 64 */
//        return buf_size[2]; 
//    else if (buf_size[3] >= val) /* 128 */
//        return buf_size[3]; 
//    else if (buf_size[4] >= val) /* 256 */
//        return buf_size[4]; 
//    else if (buf_size[5] >= val) /* 1024 */
//        return buf_size[5]; 
//  else if (buf_size[6] >= val) /* 2048 */
//        return buf_size[6]; 
//    else if (buf_size[7] >= val) /* 4096 */
//        return buf_size[7]; 
//    else if (buf_size[8] >= val) /* 8192 */
//        return buf_size[8]; 
//    else if (buf_size[9] >= val) /* 16384 */
//        return buf_size[9]; 
//    else if (buf_size[10] >= val) /* 32768 */ 
//        return buf_size[10]; 
//    else 
//        return -1;   /* if val > 32768 */
// 
//    return -1; 
// } 
...
{ 
    ...
    buffer->size        = get_size(BASE_BUF)*10;  /* 1024 */
...
{ 
    ...
    len = 
strlen(buffer->string) + strlen(string) + 1;
