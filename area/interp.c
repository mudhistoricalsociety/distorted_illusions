...
/*  { "groups",		do_groups,	POS_SLEEPING,	 0,  1,  LOG_NORMAL, 1 }, */
    ...
    { "copyover",       do_copyover,    POS_DEAD,       L1,  1,  LOG_NORMAL, 1 },
    ...
    { "backup",         do_backup,      POS_DEAD,       L1,  1,  LOG_ALWAYS, 1 },
...
*/
    { "dblexp",         do_dblexp,      POS_DEAD,    L1,  1,  LOG_NORMAL, 1 },
...
//    { "nclan",          do_nclan,       POS_DEAD,       L1,  1,  LOG_NORMAL, 1 },
  //  { "ncset",          do_ncset,       POS_DEAD,       L1,  1,  LOG_NORMAL, 1 },
    ...
    { "aedit",          do_aedit,       POS_DEAD,    	 L5,  1,  LOG_NORMAL, 1 },
    ...
    { "alist",          do_alist,       POS_DEAD,        L6,  1,  LOG_NORMAL, 1 },
    ...
    { "imptalk",	do_imptalk,	POS_DEAD,	IM,  1,  LOG_NORMAL, 1 },
